...
const App: React.FC = () => {
  ...
  return (
    <>
      <h1 className="text-4xl font-bold text-white text-center py-12 rounded-lg shadow-lg">
        Roster Management
      </h1>
      ...
      <FormProvider {...useForm()}>
        ...
        >
          <FormField
            name="username"
            render={({ field }) => (
              <FormItem className="flex flex-col sm:flex-row gap-6 items-center text-gray-200">
                ...
                <FormControl>
                  <input
                    ...
                    type="text"
                    value={name}
                    className="w-60 p-2 text-gray-800 rounded-md focus:outline-none focus:ring focus:ring-indigo-300"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
      ...
      <div className="flex justify-between mx-[18rem] items-center">
        {/* Search Field */}
        <div className="flex justify-center my-4">
          <input
            ...
            className="w-80 p-2 text-gray-800 rounded-md focus:outline-none focus:ring focus:ring-indigo-300"
          />
        </div>
        <Popover>
          <PopoverTrigger>
      ...
      <Table className="w-[70%] mx-auto text-gray-200 rounded-lg shadow-lg overflow-hidden">
        ...
        <TableBody>
          {filteredData.length > 0 ? (
                  ...
                  <>
                    <TableCell className="px-4 py-2 text-black">
                      <select
                        ...
                        className={
                          row.monday === "WFH" ? "bg-red-500" : "bg-green-500"
                        }
                      >
                    ...
                    <TableCell className="px-4 py-2 text-black">
                      <select
                        ...
                        className={
                          row.tuesday === "WFH" ? "bg-red-500" : "bg-green-500"
                        }
                      >
                        <option value="WFH">WFH</option>
                        <option value="WFO">WFO</option>
                    ...
                    <TableCell className="px-4 py-2 text-black">
                      <select
                        ...
                        className={
                          row.thursday === "WFH" ? "bg-red-500" : "bg-green-500"
                        }
                      >
                        <option value="WFH">WFH</option>
                        <option value="WFO">WFO</option>
                    ...
                    <TableCell className="px-4 py-2 text-black">
                      <select
                        ...
                        className={
                          row.friday === "WFH" ? "bg-red-500" : "bg-green-500"
                        }
                      >
                        <option value="WFH">WFH</option>
                        <option value="WFO">WFO</option>
            ...
            <TableRow>
              <TableCell
                colSpan={2}
                className="text-center py-6 text-gray-400 flex items-center justify-center"
              >
